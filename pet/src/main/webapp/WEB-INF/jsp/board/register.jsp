...
<div class="register-page">	
	<div class="form">
		<h1>SIGN UP</h1>
		<form name="register_form" id="regiform" accept-charset="UTF-8" action="insertInfo.do"
			onsubmit='return checksubmit();'>
			<table class="in_form">
				<tr>
					<td>아이디</td>
					<td><input type="text" name="ID" id="id" placeholder="아이디(5~20자)">
						<input type="button" id="checkId" value="중복확인" class="button" /> 
				...
				<tr>
					...
					<td><input type="text" id="postcode" placeholder="우편번호"
						...
						onclick="execDaumPostcode()" value="우편번호 찾기" class="button"><br> <input
				...
				<tr>
					<td colspan="2" align="center"><input type="submit" 
						value="가입하기" id="submit" disabled="false" class="button"><input type="reset" value="다시작성" class="button"></td>
				</tr>
			</table>
		</form>
	</div>
